...
Go to https://portal.azure.com/#create/Microsoft.KeyVault and fill out creation form.

![PSAM2]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM2.jpg)

With KeyVault created you can then add entry for your service account.

![PSAM3]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM3.jpg)

![PSAM4]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM4.jpg)
...
Go to https://portal.azure.com/#create/Microsoft.AutomationAccount and fill out creation form.

![PSAM5]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM5.jpg)
...
![PSAM6]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM6.jpg)

Key component of `Azure Automation` is `AzureRunAsAccount`

![PSAM7]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM7.jpg)
...
![PSAM8]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM8.jpg)

In next step select secrets permissions

![PSAM9]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM9.jpg)

Select your `AzureRunAsAccount` as principal

![PSAM10]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM10.jpg)

And do not forget to click **Save**!!

![PSAM11]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM11.jpg)
...
![PSAM12]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM12.jpg)

## Azure DevOps repository

Now that you've got automation to run your scripts, create repository for them 🧱.
Go to https://dev.azure.com/ and create a new project if you don't have one.

![PSAM13]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM13.jpg)

Initialize a new repo

![PSAM14]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM14.jpg)

Then create a new folder and file within

![PSAM15]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM15.jpg)

Go back to your `Automation Account` and procced to `Source Control` blade and click **Add**

![PSAM16]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM16.jpg)

![PSAM17]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM17.jpg)

Click authenticate to connect to `DevOps`

![PSAM18]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM18.jpg)

Fill out the rest of the form

![PSAM19]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM19.jpg)

>Note: Remember to set **Publish runbook** to **Yes**. Otherwise you will have to **publish** after every sync manually.

![PSAM20]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM20.jpg)

This is how sync should look like

![PSAM21]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM21.jpg)
...
![PSAM22]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM22.jpg)

Select your service account

![PSAM23]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM23.jpg)

Proceed with **Assign**

![PSAM24]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM24.jpg)

One last thing you will need from that blade is `roleID`. The fastest way is to copy it from address bar

![PSAM25]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM25.jpg)
...
![PSAM26]({{ site.url }}{{ site.baseurl }}/assets/images/posts/2021-01-11-PSAM/PSAM26.jpg)
